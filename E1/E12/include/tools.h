...
/*
* Calculate the acceleration. All vectors are assumed to be of length 3
*
* Parameters
* ----------
...
/**
* Perform one velocity Verlet step. All vectors are assumed to be of length 3
*
* Parameters
* ----------
...
* positions - Vector of positions
* velocities - Vector of velocities
* alpha - energy transfer constant
* timestep - Time step
*
*/
